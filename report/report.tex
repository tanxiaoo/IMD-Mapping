...
%   xelatex report.tex   (twice, for cross-references)
...
% Figures are referenced without the ../outputs_* prefix.
\graphicspath{{../}{figs/}}
...
[1, p.~5] rather than adding to it: he reports SVR best on cross-validation with
...
is supported in Earth Engine through \texttt{ee.Classifier.libsvm} [9] with
...
\begin{figure}[htbp]
  ...
  \caption{RMSE and MAE with 95\,\% percentile bootstrap [14] confidence intervals
...
signed-rank [11] on per-plot absolute error with Benjamini-Hochberg control of
the false discovery rate [12] within the city.
...
\item[{[1]}] Žgela, M. (2026). \textit{Imperviousness Mapping Using Satellite
Embeddings and Method Transferability and Application in Vietnam.} Report of the
activities, open call BANDO N. 2026\_VALCOMP\_DICA\_9, ID 18754, call ID 12370.
...
\item[{[2]}] Brown, C. F., Kazmierski, M. R., Pasquarella, V. J., Rucklidge, W. J.,
...
label data. \textit{arXiv preprint} arXiv:2507.22291.

\item[{[3]}] European Union, Copernicus Land Monitoring Service (2018).
\textit{Imperviousness Density 2018 (raster 10 m), Europe, 3-yearly.} European
Environment Agency.
\url{https://doi.org/10.2909/3bf542bd-eebd-4d73-8d62-0f1ffb8b3b0b}

\item[{[4]}] European Space Agency (2018). \textit{Copernicus Sentinel-2 MSI
Level-2A surface reflectance.} Processed by ESA. Accessed through Google Earth
Engine as \path{COPERNICUS/S2_SR_HARMONIZED}.

\item[{[5]}] Pesaresi, M., \& Politis, P. (2023). \textit{GHS-BUILT-S R2023A: GHS
built-up surface grid, derived from Sentinel-2 composite and Landsat,
...
\item[{[6]}] Gorelick, N., Hancher, M., Dixon, M., Ilyushchenko, S., Thau, D., \&
Moore, R. (2017). Google Earth Engine: Planetary-scale geospatial analysis for
everyone. \textit{Remote Sensing of Environment}, 202, 18-27.
\url{https://doi.org/10.1016/j.rse.2017.06.031}

\item[{[7]}] Breiman, L. (2001). Random forests. \textit{Machine Learning}, 45(1),
5-32. \url{https://doi.org/10.1023/A:1010933404324}

\item[{[8]}] Drucker, H., Burges, C. J. C., Kaufman, L., Smola, A., \& Vapnik, V.
(1996). Support vector regression machines. In \textit{Advances in Neural
Information Processing Systems} 9 (pp. 155-161). MIT Press.

\item[{[9]}] Chang, C.-C., \& Lin, C.-J. (2011). LIBSVM: A library for support
vector machines. \textit{ACM Transactions on Intelligent Systems and Technology},
2(3), 27. \url{https://doi.org/10.1145/1961189.1961199}

\item[{[10]}] Pedregosa, F., Varoquaux, G., Gramfort, A., Michel, V., Thirion, B.,
...
Scikit-learn: Machine learning in Python. \textit{Journal of Machine Learning
Research}, 12, 2825-2830.

\item[{[11]}] Wilcoxon, F. (1945). Individual comparisons by ranking methods.
\textit{Biometrics Bulletin}, 1(6), 80-83. \url{https://doi.org/10.2307/3001968}

\item[{[12]}] Benjamini, Y., \& Hochberg, Y. (1995). Controlling the false discovery
rate: A practical and powerful approach to multiple testing. \textit{Journal of the
Royal Statistical Society: Series B}, 57(1), 289-300.
\url{https://doi.org/10.1111/j.2517-6161.1995.tb02031.x}

\item[{[13]}] Kruskal, W. H., \& Wallis, W. A. (1952). Use of ranks in one-criterion
variance analysis. \textit{Journal of the American Statistical Association},
47(260), 583-621. \url{https://doi.org/10.1080/01621459.1952.10483441}

\item[{[14]}] Efron, B., \& Tibshirani, R. J. (1993). \textit{An Introduction to the
Bootstrap.} Chapman \& Hall, New York.

\item[{[15]}] Esri (2024). \textit{How Average Nearest Neighbor works.} ArcGIS Pro
documentation.
