...
% (figs/milan_clms_embedding/, figs/milan_validation/, ...) so the paths below are
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{milan_clms_embedding/fig01_spatial_split.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{milan_clms_percentile/fig07_holdout_scatter.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{milan_clms_percentile/figC_perclass_GEE_RF.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{milan_clms_percentile/figD_importance_RF.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\textwidth]{transfer_embedding/fig01_transfer_comparison.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\textwidth]{transfer_median/fig01_transfer_comparison.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{transfer_embedding/fig_obs_vs_pred_hanoi_hcmc.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{transfer_embedding/fig02_per_class_mae.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{milan_validation/fig02_forest_ci.png}
...
\begin{figure}[p]
  ...
  \includegraphics[width=\textwidth,keepaspectratio]%
    {milan_validation/fig01_scatter_grid.png}
